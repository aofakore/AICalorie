...
public class TensorFlowYoloDetector implements com.co.AICalorie.AICalorie.Classifier {
//    private static final Logger LOGGER = new Logger();
    ...
    public static com.co.AICalorie.AICalorie.Classifier create(
        ...
        for (int y = 0; y < gridHeight; ++y) {
            for (int x = 0; x < gridWidth; ++x) {
                for (int b = 0; b < NUM_BOXES_PER_BLOCK; ++b) {
                    ...
                    Log.e("TESTING",String.format("confindence: %d,class: %s",confidenceInClass,LABELS[detectedClass]));
