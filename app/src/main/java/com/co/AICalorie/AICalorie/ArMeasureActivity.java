...
import com.co.AICalorie.AICalorie.common.helpers.DisplayRotationHelper;
import com.co.AICalorie.AICalorie.rendering.BackgroundRenderer;
import com.co.AICalorie.AICalorie.rendering.ObjectRenderer;
import com.co.AICalorie.AICalorie.rendering.PlaneRenderer;
import com.co.AICalorie.AICalorie.rendering.PointCloudRenderer;
...
import com.co.AICalorie.AICalorie.renderer.RectanglePolygonRenderer;
...
//            log(TAG, "onScroll, dx=" + distanceX + " dy=" + distanceY);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_measure_activity);
...
//                popUp.showAsDropDown(v, 0, 0); // show popup like dropdown list
    ...
    private PopupWindow getPopupWindow() {
        ...
        sortList.add(getString(R.string.action_5));
